...
#    from torchtext.experimental.datasets import WikiText2 as WikiData
    ...
    model = model.MLMTask(ntokens, args.emsize, args.nhead, args.nhid, args.nlayers, args.dropout).to(device)
    ...
    with open('pretrained_bert.pt', 'wb') as f:
        torch.save(model.bert_model, f)

# python pretrained_bert.py --seed 65568868 --epochs 12 --emsize 768 --nhid 1024  --nlayers 12 --nhead 12 --save-vocab squad_vocab.pt
